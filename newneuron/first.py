...
2. Versicolor
3. Setosa
используя для этого библиотеку numpy (от pandas) и 4 признака классификации
"""
import numpy as np


INPUT_DIM = 4  # количество входов (признаки)
OUT_DIM = 3  # количество выходов (классы)
H_DIM = 10  # рандомное количество нейронов в 1 слое
